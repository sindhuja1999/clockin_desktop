...
function(
		 ...
		 */
		FilterOperatorUtil.getEQOperator = function() {
		 ...
		 */
		FilterOperatorUtil.onlyEQ = function(aOperators) {
		 ...
		 * @public
		 */
		FilterOperatorUtil.updateConditionValues = function(oCondition) {
		 ...
		 * @since: 1.76.0
		 */
		FilterOperatorUtil.indexOfCondition = function(oCondition, aConditions) {
		 ...
		 * @since: 1.76.0
		 */
		FilterOperatorUtil.compareConditions = function(oCondition1, oCondition2) {
		 ...
		 * @since: 1.76.0
		 */
		FilterOperatorUtil.compareConditionsArray = function(aConditions1, aConditions2) {
		 ...
		 * @since: 1.78.0
		 */
		FilterOperatorUtil.checkConditionValidated = function(oCondition) {
