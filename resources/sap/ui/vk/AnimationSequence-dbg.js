...
sap.ui.define([
	...
	AnimationSequence.prototype.removeJoint = function(jointData) {
		...
		var nodes = [];
		if (!jointData) {
			this._jsonData.forEach(function(joint){
	...
	AnimationSequence.prototype.getNodeBoundaryProperty =  function(nodeRef, type, isEnd) {
		var property;
	...
	AnimationSequence.prototype._hasCompleteNodesBoundaryProperties = function() {
	...
	AnimationSequence.prototype._clearNodesBoundaryProperties = function() {
	...
	AnimationSequence.prototype._setCurrentNodesPropertiesAsBoundary = function(viewStateManager, isEnd, forced) {
		if (!forced && ((this._nodeEndPropertiesMap && isEnd) || (this._nodeStartPropertiesMap && !isEnd))) {
			return;
		}
	...
	AnimationSequence.prototype._getNodeEndPropertiesMap = function() {
		return this._nodeEndPropertiesMap;
	};

	AnimationSequence.prototype._getNodeStartPropertiesMap = function() {
