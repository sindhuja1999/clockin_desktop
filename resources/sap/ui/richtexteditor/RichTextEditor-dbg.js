...
sap.ui.define([
	...
	RichTextEditor.prototype.initTinyMCE4 = function() {
		...
		Core.getEventBus().subscribe("sap.ui", "__beforePopupClose", this._tinyMCE4PreserveHandler, this);
	};
	...
	RichTextEditor.prototype.exitTinyMCE4 = function() {
		...
		Core.getEventBus().unsubscribe("sap.ui", "__beforePopupClose", this._tinyMCE4PreserveHandler);
