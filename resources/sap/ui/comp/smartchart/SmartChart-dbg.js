...
sap.ui.define([
	...
	SmartChart.prototype._createChart = function() {
		...
		this._oChart.attachRenderComplete(function(){
			var sChartId = "#" + this._oChart.getId();

			if (sap.ui.Device.browser.safari ){
				jQuery(sChartId).parent().addClass("sapUiCompSmartChartInnerChartSafari");

			} else if (sap.ui.Device.browser.chrome ){
				jQuery(sChartId).parent().addClass("sapUiCompSmartChartInnerChartChrome");
			}
		}.bind(this));
