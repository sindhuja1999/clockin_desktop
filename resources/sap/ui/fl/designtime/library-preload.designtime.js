...
sap.ui.predefine('sap/ui/fl/designtime/util/IFrame.designtime',["sap/ui/rta/plugin/iframe/AddIFrameDialog","sap/ui/core/IconPool","sap/m/library"],function(A,I){"use strict";I.registerFont({collectionName:"tnt",fontFamily:"SAP-icons-TNT",fontURI:sap.ui.require.toUrl("sap/tnt/themes/base/fonts"),lazy:true});
...
return{actions:{settings:function(){return{icon:"sap-icon://tnt/content-enricher",name:"CTX_EDIT_IFRAME",isEnabled:true,handler:e};},remove:{changeType:"hideControl"}}};});
