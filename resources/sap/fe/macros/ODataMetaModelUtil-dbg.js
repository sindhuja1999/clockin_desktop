...
sap.ui.define([], function() {
	 ...
	 *
	 * @param mAnnos {array} a named map of annotations from a given entity set
	 * @return mDataPoints{object} a keyed mapped ordered by
	 * <ul>
	 ...
	 *
	 * @param oSortRestrictions {object} The sort restrictions annotation
	...
	/**
	 *
	 * @param oProperty {object} the Entity Property
	 * @param oSortRestrictionInfo {object} the SortInformation restrictions
	 */
	 ...
	 *
	 * @param oFilterRestrictions {object} the filter restrictions annotation
	 ...
	 *
	 * @param oProperty {object} the entity property
	 * @param oFilterRestrictionInfo {object} the filter restrictions
	 */
	 ...
	 *
	 * @param sEdmType {string} the Edm type, like Edm.String, Edm.Int16...
