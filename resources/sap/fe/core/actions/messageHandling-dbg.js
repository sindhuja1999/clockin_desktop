	...
	function(MessageToast, MessageItem, MessageView, Button, Dialog, MessageType, Filter, FilterOperator, Message, IconPool) {
		...
		function getTranslatedTextForMessageDialog(sHighestPriority) {
			...
			switch (sHighestPriority) {
				case "Error":
					return oResourceBundle.getText("SAPFE_ERROR_MESSAGES_PAGE_TITLE_ERROR");
				case "Information":
					return oResourceBundle.getText("SAPFE_ERROR_MESSAGES_PAGE_TITLE_INFO");
				case "Success":
					return oResourceBundle.getText("SAPFE_ERROR_MESSAGES_PAGE_TITLE_SUCCESS");
				case "Warning":
					return oResourceBundle.getText("SAPFE_ERROR_MESSAGES_PAGE_TITLE_WARNING");
				default:
					return oResourceBundle.getText("SAPFE_ERROR_MESSAGES_PAGE_TITLE");
			}
		}
