sap.ui.define(["sap/ui/core/mvc/OverrideExecution","sap/suite/ui/generic/template/lib/TemplateAssembler",
	...
	"sap/ui/model/json/JSONModel", "sap/suite/ui/generic/template/AnalyticalListPage/controllerFrameworkExtensions", "sap/suite/ui/generic/template/js/preparationHelper"
], function(OverrideExecution, TemplateAssembler, ControllerImplementation, JSONModel, controllerFrameworkExtensions, preparationHelper) {
	"use strict";
	...
	function getMethods(oComponent,oComponentUtils) {
		...
		return {
			...
			getTemplateSpecificParameters: function(oMetaModel, oSettings, Device, sLeadingEntitySet){
				return {
					tableSettings: preparationHelper.getNormalizedTableSettigs(oMetaModel, oSettings, Device, sLeadingEntitySet), 
