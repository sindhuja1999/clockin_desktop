	...
	var vfdController = Controller.extend("sap.suite.ui.generic.template.AnalyticalListPage.controller.VisualFilterDialogController", {
		...
		*/
		...
		_addChartCustomToolbar: function(obj, idx) {
			...
			sId = this.oState.alr_visualFilterBar.getView().sId + "--" + StableIdHelper.getStableId({type: "VisualFilterDialog", subType: "ValueHelpButton", sProperty: props.parentProperty}),
			count,
			items = [
					new Button({
						type: "Transparent",
