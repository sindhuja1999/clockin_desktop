sap.ui.define(["sap/ui/base/Object",
	...
	function(BaseObject, Device, JSONModel, MessageToast, ActionSheet, Dialog, Popover, deletionHelper,
		routingHelper, CRUDActionHandler, ContextBookkeeping, CRUDHelper, StatePreserver, testableHelper,
		Log, syncStyleClass, extend, Fragment) {
		"use strict";
		...
		function getMethods(oTemplateContract) {
			...
			function fnNavigateToContextArray(aContext, bReplaceInHistory){
				oTemplateContract.oNavigationControllerProxy.navigateToSubContext(aContext, bReplaceInHistory, 0);
			}
			...
			*/
			...
			function getCRUDActionHandler(oController, oCommonUtils){
				return new CRUDActionHandler(oTemplateContract, oController, oCommonUtils);
			}
			...
			return {
				...
				navigateToContextArray: fnNavigateToContextArray,
				getContentDensityClass: getContentDensityClass,
