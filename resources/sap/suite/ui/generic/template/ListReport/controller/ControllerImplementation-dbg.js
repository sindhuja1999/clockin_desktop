...
sap.ui.define([
	...
	"sap/suite/ui/generic/template/ListReport/controller/CreateWithDialogHandler"
], function(Filter, ExtensionAPI, listUtils, IappStateHandler, MultipleViewsHandler,
		        WorklistHandler, ShareUtils, Log, ObjectPath, StableIdHelper, deepExtend, CreateWithDialogHandler) {
	"use strict";
