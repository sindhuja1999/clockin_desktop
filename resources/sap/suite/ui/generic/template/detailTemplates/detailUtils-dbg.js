sap.ui.define(["sap/base/Log", "sap/ui/core/UIComponent", "sap/ui/core/routing/HashChanger", "sap/ui/model/Filter", "sap/ui/model/FilterOperator",
	...
	function(Log, UIComponent, HashChanger, Filter, FilterOperator, NavigationController, MessageButtonHelper, testableHelper, DiscardEditHandler, PaginatorButtonsHelper, DraftTransactionController, NonDraftTransactionController) {
		"use strict";
...
//						oTemplateUtils.oServices.oApplication.showMessageToast(oTemplateUtils.oCommonUtils.getText("ST_CHANGES_APPLIED"));
			...
			function fnApplyAndUp(oEvent) {
				...
				oControllerBase.state.CRUDActionHandler.handleCRUDScenario(2, fnApplyAndUpImpl.bind(null, oControl));
			}
			...
			oControllerBase = {
				onInit: function(oRequiredControls, fnPrepareAllMessagesForNavigation, messageSorter, getGroupTitle){
					if (!oRequiredControls || oRequiredControls.footerBar){
						...
						oControllerBase.state.CRUDActionHandler = oTemplateUtils.oServices.oApplication.getCRUDActionHandler(oController, oTemplateUtils.oCommonUtils);
