...
sap.ui.define(["sap/ui/thirdparty/jquery", "sap/ui/core/format/NumberFormat", "sap/ui/core/format/DateFormat",
    ...
    "sap/ovp/cards/MetadataAnalyser", "sap/base/security/encodeURL"],
    function (jQuery, NumberFormat, DateFormat, CommonUtils, OdataAnnotationHelper,
        FilterOperator, Device, odata4analytics, SelectionVariant, OvpResources, formatMessage, Log, isPlainObject, each, MetadataAnalyser, encodeURL) {
        "use strict";
