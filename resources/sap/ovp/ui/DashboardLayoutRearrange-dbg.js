sap.ui.define(["sap/ovp/ui/UIActions",
    ...
    Rearrange.prototype._resizeStartHandler = function (evt, cardElement) {
        ...
        this.layoutUtil.startResizeCardConfig = jQuery.extend(true, [], this.layoutUtil.getCards());
    ...
    Rearrange.prototype._dragStartHandler = function (evt, cardElement) {
        ...
        this.layoutUtil.dragStartCardsConfig = jQuery.extend(true, [], this.layoutUtil.getCards());
