...
sap.ui.define([
...
], function (oAbapUtils, jQuery, URI) {
    "use strict";
    /*global OData */
    ...
    function getAndAdjustServiceURL (oStartupCallResult, sServicePropertyName, sFallbackBaseUrl,
        ...
        var sLanguageParam = extractParamFromUrl("sap-language");
        if (sLanguageParam) {
            sServiceUrl += (sServiceUrl.indexOf("?") < 0 ? "?" : "&") + "sap-language=" + sLanguageParam;
        }
    ...
    /**
     *
     * @param sParam The name of the url parameter
     * @returns {string} The value of the parameter
     */
    function extractParamFromUrl(sParam) {
        return URI.fromURL(window.location.href.split("#")[0]).get(sParam);
    }
