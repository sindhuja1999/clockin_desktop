    ...
    CommonDataModel.prototype._loadAndApplyPagePersonalization = function (oPage) {
            ...
            this._oAdapter.getPersonalization(this._oOriginalSite._version)
                .done(function (oPersonalization) {
                    if (Object.keys(oPersonalization).length) {
                        ...
                        var oVersion = new Version(oPersonalization._version);
        ...
        return oPersonalizationPromise
            .then(function (oPersonalization) {
                ...
                var oConvertedPage = this._oSiteConverter.convertTo("3.0.0", deepClone(oPage));

                return this._triggerMixinPersonalisationInSite(oConvertedPage, oPagePersonalization);
            }.bind(this))
            .then(function (oPersonalizedSite) {
                this._oPersonalizedPages[sPageId] = this._oSiteConverter.convertTo("3.1.0", deepClone(oPersonalizedSite));
