...
sap.ui.define([
    ...
    function generateURLTemplateResolutionResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        var oResult = {
            applicationType: "URL",
            text: oInbound.title,
            appCapabilities: createAppCapabilities(oTemplateContext.payload.capabilities || {}, oTemplateContext.siteAppSection),
            url: sURL,
            extendedInfo: getExtendedInfo(oMatchingTarget, sURL)
        };
     ...
     *
     */
    function createAppCapabilities (oTemplateCapabilities, oSiteAppSection) {
    ...
    function getExtendedInfo (oMatchingTarget) {
        var oInfo = {
        };
