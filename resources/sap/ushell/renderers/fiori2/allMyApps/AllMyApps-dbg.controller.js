...
sap.ui.define([
    ...
    var KeyboardNavigation = function (oView) {
        this.init(oView);
    };
    ...
    sap.ui.controller("sap.ushell.renderers.fiori2.allMyApps.AllMyApps", {
        ...
        handleGroupPress: function (ev) {
            var oView = this.getView(),
                oData = oView.oCustomLink ? oView.oCustomLink.getBindingContext("allMyAppsModel").getObject() : {};
        ...
        /**
         * Returns the current state of the AllMyApps UI which is a value of sap.ushell.AllMyAppsState that is read from the AllMyApps model.
         *
