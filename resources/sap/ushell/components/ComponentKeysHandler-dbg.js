                    ...
                    if (bFocusPassedFirstTime) {
                        ...
                        if (sTagName === "INPUT" || sTagName === "TEXTAREA") {
                            if (oEvent.keyCode === handler.keyCodes.ENTER) {
                                var jqHeaderElement = jQuery(document.activeElement).closest(".sapUshellTileContainerHeader");

                                if (jqHeaderElement.length) {
                                    setTimeout(function () {
                                        jqHeaderElement = jQuery("#" + jqHeaderElement[0].id);
                                        handler._setTabIndexOnTileContainerHeader(jqHeaderElement);
