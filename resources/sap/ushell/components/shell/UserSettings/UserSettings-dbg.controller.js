...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.shell.UserSettings", {
        ...
        _handleSettingsSave: function () {
            ...
            var isDetailedEntryMode = Config.last("/core/userPreferences/isDetailedEntryMode");
            if (isDetailedEntryMode) {
                Config.emit("/core/userPreferences/activeEntryPath", null);
            }

            utils.saveUserPreferenceEntries(Config.last("/core/userPreferences/entries"))
